...
const config = {
    ...
    // Main project/link buttons
    links: [
        {
            text: "Portfolio",
            url: "https://nilay-naha-portfolio.vercel.app",
        ...
        {
            text: "Portfolio V1",
            url: "https://aminilay.github.io/nilay-naha-portfolio-v1",
            icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="7" width="18" height="13" rx="2" ry="2"/><path d="M8 7V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>`
        },
        {
            text: "PyPass Manager",
        ...
        {
            text: "WeatherVista",
            url: "https://aminilay.github.io/WeatherVista",
            icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z"/></svg>`
        },
        {
            text: "Ultimate Calculator Hub",
            url: "https://aminilay.github.io/ultimate-calculator-hub",
            icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="2" width="16" height="20" rx="2"/><line x1="8" y1="6" x2="16" y2="6"/><line x1="8" y1="10" x2="16" y2="10"/><line x1="8" y1="14" x2="12" y2="14"/><line x1="8" y1="18" x2="12" y2="18"/><line x1="16" y1="14" x2="16" y2="18"/></svg>`
        },
        {
            text: "CalculatorPro",
        ...
        {
            text: "Personal Blog",
            url: "https://personal-blog-sooty-two.vercel.app",
        ...
        },
        {
            ...
            url: "https://github.com/AmiNilay/Basic-Library-Management-System",
        ...
        {
            text: "Tic-Tac-Toe with AI Opponent",
            url: "https://drive.google.com/file/d/1y5oieLIDpappdMr--xcNXnprVZ9oYCBn/view",
        ...
        {
            text: "SmartCalculator",
            url: "https://drive.google.com/file/d/1WMj7qymk7zceD5FVSPgBUgaJ3fFVvZg1/view",
            icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"></rect><line x1="8" y1="6" x2="16" y2="6"></line><line x1="16" y1="10" x2="8" y2="10"></line><line x1="16" y1="14" x2="8" y2="14"></line><line x1="16" y1="18" x2="8" y2="18"></line></svg>`
        },
        {
            text: "Personal Link Page (LinkCascade)",
            url: "#",
            icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>`
        },
        {
            text: "Copy Email Address",
            url: `mailto:${"nilay.naha.2022@gmail.com"}`,
            type: "email",
    ...
    // Social media links
    social: {
        github: "https://github.com/AmiNilay",
        linkedin: "https://www.linkedin.com/in/nilay-naha/",
        facebook: "https://www.facebook.com/share/1ABaVjb72Z/",
        twitter: "https://x.com/naha_nilay?s=08 ",
        instagram: "https://www.instagram.com/nilaynaha2003"
    }
};
